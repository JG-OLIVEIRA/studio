...
'use server';
/**
 * @fileOverview A Genkit flow for moderating user-submitted reviews.
 *
 * This file defines the `moderateReviewFlow`, which uses an AI model to check
 * if a review's text is appropriate. It helps prevent hate speech, personal
 * attacks, and other inappropriate content from being published.
 *
 * - moderateReviewFlow - The main moderation function.
 * - ModerationInputSchema - Zod schema for the flow's input (the review text).
